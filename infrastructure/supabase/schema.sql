...
drop policy if exists "Restrict insert to alerts to authenticated roles" on public.alerts;
...
drop policy if exists "Allow public read access to shelters" on public.shelters;
drop policy if exists "Restrict insert to shelters to authenticated roles" on public.shelters;
...
drop policy if exists "Allow public read access to roads" on public.roads;
drop policy if exists "Restrict insert to roads to authenticated roles" on public.roads;
...
drop policy if exists "Restrict insert to assets to authenticated roles" on public.assets;
...
drop policy if exists "Restrict insert to messages to authenticated roles" on public.messages;
